...
for file in all_hist_files:
    try:
        ...
        # Resample to annual → count number of PR ≥ 20 mm/day days
...
# Print results
print("\n📊 Number of Days with PR ≥ 20 mm/day by Bioregion (Ensemble Average):")
print(df)
...
bioregions_merged.plot(
    ...
    legend=True,
    legend_kwds={
        "label": "Days with PR ≥ 20 mm/day (Annual Avg)",
...
ax.set_title("CMIP6: Days with PR ≥ 20 mm/day by Veg Biomes (1950-2014)", fontsize=14)
ax.set_axis_off()
plt.tight_layout()
plt.show()